...
class DirtyShip(val plugin: DirtyShipPlugin) : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        "${mainUrl}/category/amateur-ef/"      to  "Amateur",
        "${mainUrl}/category/anal-def/"        to  "Anal",
        "${mainUrl}/category/anime/"           to  "Anime",
        "${mainUrl}/category/asian-efg/"       to  "Asian",
        "${mainUrl}/category/asmr-i/"          to  "ASMR",
        "${mainUrl}/category/big-boobs-i/"     to  "Big Boobs",
        "${mainUrl}/category/big-dick/"        to  "Big Dick",
        "${mainUrl}/category/blowjob-i/"       to  "Blowjob",
        "${mainUrl}/category/celebrity-ef/"    to  "Celebrity",
        "${mainUrl}/category/cosplayer-x/"     to  "Cosplayer",
        "${mainUrl}/category/couple-b/"        to  "Couple",
        "${mainUrl}/category/fansly-g/"        to  "Fansly",
        "${mainUrl}/category/indian/"          to  "Indian",
        "${mainUrl}/category/instagram-cde/"   to  "Instagram",
        "${mainUrl}/category/involuntary/"     to  "Involuntary",
        "${mainUrl}/category/loyalfans/"       to  "LoyalFans",
        "${mainUrl}/category/onlyfans-j/"      to  "OnlyFans",
        "${mainUrl}/category/patreon-e/"       to  "Patreon",
        "${mainUrl}/category/snapchat-d/"      to  "Snapchat",
        "${mainUrl}/category/squirting-de/"    to  "Squirting",
        "${mainUrl}/category/teen-ef/"         to  "Teen",
        ...
        "${mainUrl}/category/youtube-c/"       to  "YouTube",
    )
